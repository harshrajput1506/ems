  ...
  useEffect(() => {
    ...
    return (
      ...
      {isMobile ?
          ...
          <div ref={sidebarRef} className={`z-50 fixed h-screen w-1/2 top-0 left-0  bg-black text-white p-4 h-auto transition-transform transform ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
            {
